      ...
      <nb-layout-column>
        <nb-card>
          <nb-card-body>
            ...
            <nb-progress-bar type='primary' [value]="70">7 of 10</nb-progress-bar>
            <nb-progress-bar type='danger' size='xlg' [value]="50">xlg</nb-progress-bar>
            <nb-progress-bar type='warning' size='lg' [value]="40">lg</nb-progress-bar>
            <nb-progress-bar type='info' size='sm' [value]="60">sm</nb-progress-bar>
            <nb-progress-bar type='primary' size='xs' [value]="70">xs</nb-progress-bar>
          </nb-card-body>
        </nb-card>
      </nb-layout-column>
    </nb-layout>
