...
function registerNebularModules(options: Schema): Rule {
  return async (tree: Tree) => {
    ...
    addModuleImportToRootModule(tree, nebularThemeModule, '@beast/theme', project);
    addModuleImportToRootModule(tree, 'NbLayoutModule', '@beast/theme', project);
    addModuleImportToRootModule(tree, 'NbEvaIconsModule', '@beast/eva-icons', project);
  };
}
